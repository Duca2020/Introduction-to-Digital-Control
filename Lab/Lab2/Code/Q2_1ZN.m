...
% %remover a secao a seguir pois eh de ganho critico
% % ---------------------------------------------------------------------
...
% grid on;
% filepath = strcat(path_fig, '\Motor DC em malha fechada (Experimental - 1ZN).png');
% saveas(gcf, filepath);
...
grid on
filepath = strcat(path_fig, '\PID com controlador (1ZN).png');
saveas(gcf, filepath);
